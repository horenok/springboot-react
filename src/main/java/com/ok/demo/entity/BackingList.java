...
@Entity
@SequenceGenerator(name="SeqGenerator", sequenceName = "SEQ_BACKING_LIST_ID", allocationSize = 1)
@Table(name = TABLE_PREFIX + "BACKING_LIST")
@Where(clause = " IS_DEL='N'")
public class BackingList extends AuditableEntity {
